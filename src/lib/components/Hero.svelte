    ...
    {#if mounted}
      <div class="hero-text" in:fly={{ y: 40, duration: 800, delay: 100, easing: quintOut }}>
        ...
        <div class="hero-meta" in:fly={{ y: 20, duration: 700, delay: 600, easing: quintOut }}>
          ...
          <div class="meta-item">
            <span class="meta-label">Full Application</span>
            <span class="meta-value highlight">8 August 2025</span>
          </div>
          <div class="meta-divider"></div>
          <div class="meta-item">
            <span class="meta-label">Legal Basis</span>
            <span class="meta-value">Art. 114 TFEU</span>
          </div>
        </div>
...
<style>
  ...
  .orb-2 {
    width: 300px;
    height: 300px;
    background: linear-gradient(135deg, var(--eu-gold), #fde68a);
    bottom: -50px;
    left: -50px;
    animation-delay: -4s;
  }
